...
gulp.task('inject', ['inject-vendor', 'inject-angular', 'inject-css', 'templatecache'], function () {
...
gulp.task('inject-css', function () {
    ...
    return gulp
        .src(config.paths.index)
        .pipe(inject(
            gulp.src(config.css), {ignorePath: 'dist', addRootSlash: true, relative: false, addSuffix: '/'}))
        .pipe(gulp.dest('./src/client/'));
